...
public class FollowOffsetArray : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        for (int i = 0; i < m_Count; i++)
        {
            ...
            newFollow._OffsetDirection = Vector3.forward * m_Offset;
            newFollow._Smoothing = m_Smoothing;

            if (i == 0)
                newFollow._FollowTform = transform;
            else
                newFollow._FollowTform = m_Followers[i - 1].transform;
